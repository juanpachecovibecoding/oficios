...
import { Heart, Server, ShieldCheck, Copy, Check, Sparkles, CreditCard, Landmark } from 'lucide-react';
...
export function Offerings() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 md:py-24 bg-[#FCFDFE]">
              ...
              {isSuccess ? (
                <div className="text-center py-8">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-xl text-xs uppercase tracking-wider"
                  >
      ...
      <div className="bg-[#FAF9F6] rounded-2xl p-8 border border-brand-gold-100 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-slate-600 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="font-bold text-brand-blue-900 text-sm">Fondo Solidario de Herramientas</span>
